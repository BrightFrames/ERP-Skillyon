...
export default function StudentSettings() {
  ...
  return (
    <div className="bg-white rounded-3xl border border-slate-100 p-6 sm:p-8 dark:bg-slate-900 dark:border-slate-800">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-xs text-slate-400 mt-0.5">
            Customize your layout preferences, theme, and language
          </p>
        </div>
      </div>
