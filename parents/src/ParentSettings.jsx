  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 dark:bg-slate-900 dark:border-slate-800">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h2 className="text-base font-bold text-gray-900 dark:text-slate-100">{t("Appearance", lang)}</h2>
          <p className="text-xs text-gray-400 mt-0.5">Customize your theme, display layout, and language</p>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-6 max-w-xl">
        {/* Theme Selector */}
        <div>
          <label className="block text-xs font-bold text-gray-500 dark:text-slate-400 mb-3 uppercase tracking-wider">{t("Theme", lang)}</label>
        ...
        <div>
          <label className="block text-xs font-bold text-gray-500 dark:text-slate-400 mb-3 uppercase tracking-wider">{t("Display Density", lang)}</label>
          <div className="flex gap-3">
        ...
        {/* Language Selector */}
        <div>
          <label className="block text-xs font-bold text-gray-500 dark:text-slate-400 mb-2 uppercase tracking-wider">{t("Language", lang)}</label>
          <select
